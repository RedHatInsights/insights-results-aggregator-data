	...
	RuleContent1 = types.RuleContent{
		...
		ErrorKeys: map[string]types.RuleErrorKeyContent{
			ErrorKey1: {
				...
				TotalRisk:  (RuleErrorKey1.Impact.Impact + RuleErrorKey1.Likelihood) / 2,
				Metadata: types.ErrorKeyMetadata{
					Description: RuleErrorKey1.Description,
					Impact:      RuleErrorKey1.Impact.Impact,
	...
	RuleContent2 = types.RuleContent{
		...
		ErrorKeys: map[string]types.RuleErrorKeyContent{
			ErrorKey2: {
				...
				TotalRisk:  (RuleErrorKey2.Impact.Impact + RuleErrorKey2.Likelihood) / 2,
				Metadata: types.ErrorKeyMetadata{
					Description: RuleErrorKey2.Description,
					Impact:      RuleErrorKey2.Impact.Impact,
	...
	RuleContent3 = types.RuleContent{
		...
		ErrorKeys: map[string]types.RuleErrorKeyContent{
			ErrorKey3: {
				...
				TotalRisk:  (RuleErrorKey3.Impact.Impact + RuleErrorKey3.Likelihood) / 2,
				Metadata: types.ErrorKeyMetadata{
					Description: RuleErrorKey3.Description,
					Impact:      RuleErrorKey3.Impact.Impact,
	...
	RuleContent4 = types.RuleContent{
		...
		ErrorKeys: map[string]types.RuleErrorKeyContent{
			ErrorKey4: {
				...
				TotalRisk:  (RuleErrorKey4.Impact.Impact + RuleErrorKey4.Likelihood) / 2,
				Metadata: types.ErrorKeyMetadata{
					Description: RuleErrorKey4.Description,
					Impact:      RuleErrorKey4.Impact.Impact,
	...
	RuleContent5 = types.RuleContent{
		...
		ErrorKeys: map[string]types.RuleErrorKeyContent{
			ErrorKey5: {
				...
				TotalRisk:  (RuleErrorKey5.Impact.Impact + RuleErrorKey5.Likelihood) / 2,
				Metadata: types.ErrorKeyMetadata{
					Description: RuleErrorKey5.Description,
					Impact:      RuleErrorKey5.Impact.Impact,
