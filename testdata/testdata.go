		...
		ErrorKeys: map[string]types.RuleErrorKeyContent{
			ErrorKey1: {
				...
				Metadata: types.ErrorKeyMetadata{
					...
					ResolutionRisk: RuleErrorKey1.ResolutionRisk,
		...
		ErrorKeys: map[string]types.RuleErrorKeyContent{
			ErrorKey2: {
				...
				Metadata: types.ErrorKeyMetadata{
					...
					ResolutionRisk: RuleErrorKey2.ResolutionRisk,
		...
		ErrorKeys: map[string]types.RuleErrorKeyContent{
			ErrorKey3: {
				...
				Metadata: types.ErrorKeyMetadata{
					...
					ResolutionRisk: RuleErrorKey3.ResolutionRisk,
		...
		ErrorKeys: map[string]types.RuleErrorKeyContent{
			ErrorKey4: {
				...
				Metadata: types.ErrorKeyMetadata{
					...
					ResolutionRisk: RuleErrorKey4.ResolutionRisk,
		...
		ErrorKeys: map[string]types.RuleErrorKeyContent{
			ErrorKey5: {
				...
				Metadata: types.ErrorKeyMetadata{
					...
					ResolutionRisk: RuleErrorKey5.ResolutionRisk,
