              ...
              "type" "rule"} {"component"
                                    ...
                                    "details"
                                      {"error_key" "SAMPLES_FAILED_IMAGE_IMPORT_ERR",
                                       "info"
                                         {"condition" "Degraded",
                                          "lastTransitionTime" "2019-11-08T07:26:26Z",
                                          "message"
                                            "Samples installed at 4.2.2, with image import failures for these imagestreams: fis-java-openshift rhdm73-decisioncentral-openshift jboss-datagrid65-openshift jboss-webserver50-tomcat9-openshift rhdm73-kieserver-openshift apicast-gateway rhpam73-smartrouter-openshift php redis fuse7-java-openshift jboss-fuse70-console dotnet-runtime httpd jboss-fuse70-karaf-openshift mariadb jboss-datagrid72-openshift fuse-apicurito-generator fuse7-karaf-openshift jboss-amq-62 rhpam73-businesscentral-monitoring-openshift jboss-decisionserver64-openshift mysql jboss-datagrid71-openshift python postgresql fuse7-eap-openshift jboss-fuse70-eap-openshift golang perl rhpam73-kieserver-openshift jboss-eap71-openshift rhdm73-decisioncentral-indexing-openshift jboss-eap70-openshift eap-cd-openshift redhat-sso73-openshift openjdk-11-rhel7 nginx java redhat-sso70-openshift fis-karaf-openshift ruby jboss-webserver30-tomcat8-openshift jboss-fuse70-java-openshift jboss-datagrid71-client-openshift jboss-eap72-openshift dotnet jboss-datagrid73-openshift rhpam73-businesscentral-indexing-openshift jboss-webserver31-tomcat7-openshift jboss-webserver31-tomcat8-openshift redhat-openjdk18-openshift fuse7-console jboss-datavirt64-openshift jboss-webserver30-tomcat7-openshift modern-webapp jboss-eap64-openshift rhdm73-optaweb-employee-rostering-openshift apicurito-ui jboss-datavirt64-driver-openshift mongodb rhpam73-businesscentral-openshift jboss-processserver64-openshift redhat-sso72-openshift redhat-sso71-openshift jboss-datagrid65-client-openshift jboss-amq-63 nodejs ",
