                                    ...
                                    "type" "rule"} {"component"
                                                          ...
                                                          "details"
                                                            {"error_key" "AUTH_OPERATOR_PROXY_ERROR",
                                                             ...
                                                             "op"
                                                               {"available" {"last_trans_time" "2020-02-12T23:09:40Z",
                                                                             "message" nil,
                                                                             "reason" "NoData",
                                                                             "status" nil},
                                                                "degraded"
                                                                  {"last_trans_time" "2020-02-13T03:46:18Z",
                                                                   "message"
                                                                     "WellKnownEndpointDegraded: failed to GET well-known https://10.103.185.178:6443/.well-known/oauth-authorization-server: Service Unavailable",
                                                                   "reason" "WellKnownEndpointDegradedError",
                                                                   "status" true},
                                                                "name" "authentication",
                                                                "progressing" {"last_trans_time" "2020-02-12T23:09:40Z",
                                                                               "message" nil,
                                                                               "reason" "NoData",
                                                                               "status" nil},
                                                                "upgradeable" {"last_trans_time" "2020-02-12T23:09:40Z",
                                                                               "message" nil,
                                                                               "reason" "AsExpected",
                                                                               "status" true},
                                                                "version" nil},
