              ...
              "type" "rule"} {"component"
                                    ...
                                    "details"
                                      {"error_key" "SAMPLES_FAILED_IMAGE_IMPORT_ERR",
                                       "info"
                                         {"condition" "Degraded",
                                          "lastTransitionTime" "2020-03-23T18:27:35Z",
                                          "message"
                                            "Samples installed at 4.2.0, with image import failures for these imagestreams: redhat-openjdk18-openshift apicast-gateway ",
