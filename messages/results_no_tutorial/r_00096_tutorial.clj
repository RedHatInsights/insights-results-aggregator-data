              ...
              "type" "rule"} {"component"
                                    ...
                                    "details"
                                      {"error_key" "SAMPLES_FAILED_IMAGE_IMPORT_ERR",
                                       "info"
                                         {"condition" "Degraded",
                                          "lastTransitionTime" "2020-02-16T05:25:01Z",
                                          "message"
                                            "Samples installed at 4.2.0, with image import failures for these imagestreams: redhat-sso70-openshift rhdm73-decisioncentral-openshift jboss-datagrid73-openshift apicast-gateway jboss-webserver30-tomcat8-openshift dotnet ",
