              ...
              "type" "rule"} {"component"
                                    ...
                                    "details"
                                      {"error_key" "SAMPLES_FAILED_IMAGE_IMPORT_ERR",
                                       "info"
                                         {"condition" "Degraded",
                                          "lastTransitionTime" "2020-03-31T18:25:49Z",
                                          "message"
                                            "Samples installed at 4.3.1, with image import failures for these imagestreams: jenkins jenkins-agent-maven jenkins-agent-nodejs ; last import attempt 2020-03-31 18:25:46 +0000 UTC",
