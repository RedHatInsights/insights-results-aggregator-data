           ...
           "reports" [{"component" "ccx_rules_ocp.external.rules.samples_op_failed_image_import_check.report",
                       "details" {"error_key" "SAMPLES_FAILED_IMAGE_IMPORT_ERR",
                                  "info" {"condition" "Degraded",
                                          ...
                                          "message" "Samples installed at 4.2.0, with image import failures for these imagestreams: redhat-sso70-openshift rhdm73-decisioncentral-openshift jboss-datagrid73-openshift apicast-gateway jboss-webserver30-tomcat8-openshift dotnet ",
