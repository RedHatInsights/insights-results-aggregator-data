      ...
      [{"component"
              ...
              "details"
                {"error_key" "SAMPLES_FAILED_IMAGE_IMPORT_ERR",
                 "info"
                   {"condition" "Degraded",
                    "lastTransitionTime" "2020-02-28T21:41:28Z",
                    "message"
                      "Samples installed at 4.2.2, with image import failures for these imagestreams: redhat-sso71-openshift jboss-webserver31-tomcat8-openshift jboss-datagrid72-openshift jboss-datavirt64-openshift rhdm73-optaweb-employee-rostering-openshift jboss-datagrid71-openshift ruby rhdm73-kieserver-openshift rhpam73-kieserver-openshift rhdm73-decisioncentral-openshift jboss-datavirt64-driver-openshift jboss-datagrid73-openshift rhpam73-businesscentral-openshift rhpam73-businesscentral-monitoring-openshift rhpam73-businesscentral-indexing-openshift ",
