      ...
      [{"component"
              ...
              "details"
                {"error_key" "SAMPLES_FAILED_IMAGE_IMPORT_ERR",
                 "info"
                   {"condition" "Degraded",
                    "lastTransitionTime" "2020-03-19T18:27:04Z",
                    "message"
                      "Samples installed at 4.2.0, with image import failures for these imagestreams: jenkins-agent-nodejs jenkins jenkins-agent-maven ",
