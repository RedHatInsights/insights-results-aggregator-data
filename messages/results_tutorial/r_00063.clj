 ...
 "Report" {"fingerprints" [],
           ...
           "reports" [{"component" "ccx_rules_ocp.external.rules.nodes_requirements_check.report",
                       "details" {"error_key" "NODES_MINIMUM_REQUIREMENTS_NOT_MET",
                                  ...
                                  "nodes" [{"memory" 8.16, "memory_req" 16, "name" "masterY", "role" "master"}
                                           {"memory" 8.16, "memory_req" 16, "name" "masterA", "role" "master"}
                                           {"memory" 8.16, "memory_req" 16, "name" "masterZ", "role" "master"}],
                                  "type" "rule"},
