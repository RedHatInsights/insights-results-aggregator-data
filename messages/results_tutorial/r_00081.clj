              ...
              "type" "rule"} {"component"
                                    ...
                                    "details"
                                      {"error_key" "AUTH_OPERATOR_PROXY_ERROR",
                                       ...
                                       "op"
                                         {"available" {"last_trans_time" "2020-03-31T13:59:26Z",
                                                       "message" nil,
                                                       "reason" "NoData",
                                                       "status" nil},
                                          "degraded"
                                            {"last_trans_time" "2020-03-31T13:59:26Z",
                                             "message"
                                               "WellKnownEndpointDegraded: failed to GET well-known https://10.26.130.141:6443/.well-known/oauth-authorization-server: Forbidden",
                                             "reason" "WellKnownEndpointDegradedError",
                                             "status" true},
                                          "name" "authentication",
                                          "progressing" {"last_trans_time" "2020-03-31T13:59:26Z",
                                                         "message" nil,
                                                         "reason" "NoData",
                                                         "status" nil},
                                          "upgradeable" {"last_trans_time" "2020-03-31T13:59:26Z",
                                                         "message" nil,
                                                         "reason" "AsExpected",
                                                         "status" true},
                                          "version" nil},
