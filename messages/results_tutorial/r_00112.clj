           ...
           "reports" [{"component" "ccx_rules_ocp.external.bug_rules.bug_1766907.report",
                      ...
                      {"component" "ccx_rules_ocp.external.rules.cluster_wide_proxy_auth_check.report",
                       "details" {"error_key" "AUTH_OPERATOR_PROXY_ERROR",
                                  ...
                                  "op" {"available" {"last_trans_time" "2020-02-20T16:02:24Z",
                                                     "message" nil,
                                                     "reason" "NoData",
                                                     "status" nil},
                                        "degraded" {"last_trans_time" "2020-02-20T16:24:22Z",
                                                    "message" "WellKnownEndpointDegraded: failed to GET well-known https://10.1.72.11:6443/.well-known/oauth-authorization-server: Forbidden",
