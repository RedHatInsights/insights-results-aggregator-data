{"ClusterName" "5d5892d3-1f74-4ccf-91af-548dfc9767aa",
 ...
 "Report" {"fingerprints" [],
           "info" [],
           "pass" [],
           "reports" [{"component" "ccx_rules_ocp.external.rules.nodes_kubelet_version_check.report",
                      ...
                      {"component" "ccx_rules_ocp.external.rules.nodes_requirements_check.report",
                       "details" {"error_key" "NODES_MINIMUM_REQUIREMENTS_NOT_MET",
                                  ...
                                  "nodes" [{"memory" 3.88, "memory_req" 8, "name" "oc4", "role" "worker"}
                                           {"memory" 3.88, "memory_req" 8, "name" "oc5", "role" "worker"}],
                                  "type" "rule"},
