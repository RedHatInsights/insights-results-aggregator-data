           ...
           "reports" [{"component" "ccx_rules_ocp.external.rules.samples_op_failed_image_import_check.report",
                       "details" {"error_key" "SAMPLES_FAILED_IMAGE_IMPORT_ERR",
                                  "info" {"condition" "Degraded",
                                          ...
                                          "message" "Samples installed at 4.3.1, with image import failures for these imagestreams: jenkins jenkins-agent-maven jenkins-agent-nodejs ; last import attempt 2020-03-31 18:25:46 +0000 UTC",
