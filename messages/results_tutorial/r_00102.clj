           ...
           "reports" [{"component" "ccx_rules_ocp.external.bug_rules.bug_1766907.report",
                      ...
                      {"component" "ccx_rules_ocp.external.rules.cluster_wide_proxy_auth_check.report",
                       "details" {"error_key" "AUTH_OPERATOR_PROXY_ERROR",
                                  ...
                                  "op" {"available" {"last_trans_time" "2020-02-12T23:09:40Z",
                                                     "message" nil,
                                                     "reason" "NoData",
                                                     "status" nil},
                                        "degraded" {"last_trans_time" "2020-02-13T03:46:18Z",
                                                    "message" "WellKnownEndpointDegraded: failed to GET well-known https://10.103.185.178:6443/.well-known/oauth-authorization-server: Service Unavailable",
