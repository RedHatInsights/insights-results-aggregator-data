{"ClusterName" "5d5892d3-1f74-4ccf-91af-548dfc9767aa",
 ...
 "hxq8pq7jnf" 51824,
 "i6vgbt5v4t" {"jwnhre9571" {"cgp41lnlj0" 81363,
                             "feshwgdrd7" 90038,
                             "o7dr52ezp1" "u/}|O^n{mJJhVpH<54xO",
                             "rz4wy2y1dq" "vsioqQJGsc`lN''\"Fz2?",
                             "z5rmt0h5mn" "lRiOcial$2Z!pOS1E)-z"},
               "k6mowr67jp" "lvKWn@b(_^qY1N\\n@+-M",
               "nho55v2i25" [28921 "kq3KHU8\"F!{cm&{Eh<WE" 94115.86309103499 51791 16796.506924209232],
               "owmttapxnd" "d,g{pYoj_Odfszg{4Yl\"",
               "yl1gmypk3a" ["o1#*b;:i|}D\\/3=N>}E\\" "kQ\"[>scu3X!u*,1KNwGD" 45394 99739 "s?;(awpc:XmJr]pLTksa"]},
 "r6aobhpghy" 2950,
 "rfwiu14zkw" [67645
               [true "aMiO@1g#jgX!H=S&27k{" "x(pix*/u+@ttb)@]D`@$" 3968.757112059318 "ocaA2aIXqR>dgp@i{RA^"]
               38993
               "n:|UKz5vD{}YUdnkh@Y_"
               true]}
