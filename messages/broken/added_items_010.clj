{"ClusterName" "5d5892d3-1f74-4ccf-91af-548dfc9767aa",
 ...
 "lu4vvv8cr7" [["q#NK|G,v0YcL#bZNzU9\\" "iw09J16RyyV)r.;hSu-I" "pYH[1%!YtditqAXF<>}2" "qHnoX#s=Ts$)._W0yz-r" 82517]
               {"fi38w0snsh" "jQwi]c1mj49ufk)ToW}Y",
                "i09r5010ok" "y@t)`I;i[AFXOu\\P6{EX",
                "j1lhgiihry" 89842,
                "n8kxr9ngvs" "aT7'zrdH|7T5+'%1c4/)",
                "relv4awwtf" 16673}
               ["g/^epS4L.k=4wR>D9ap]" "o%'vtw~o#jJ/:8(R$BLZ" false "mnO6].v9.%`{DF^u|@H," "n{ubd[T\\70u6Oo<v5R!!"]
               9236
               82423.97121723546],
 "nbtznnzm06" [{"az8x9vclzi" 96524,
                "jfggenwk4h" "yn&E6q[6~^ASr9PaY9lJ",
                "npl3819wed" "qgMF|VFZi?:aU!%aJt5R",
                "stece4w4h7" "eGE*UX/5^iV@05ooReRB",
                "yepj0vl0ak" "y=%Ylh4K8$\"\\a2^7y07G"}
               34427.68584401222
               [false "eb3=pQnSYp[r)$5&0JHu" false false true]
               ["a%^.[A$E([!a1;Pz-%|V"
                ...
                39643.18850650215]
               false],
 "qs9faz2jsh" {"bvy0i5gqmn" {"c06x7fo2n1" "i<@lpD-8J`5x_o0tPtiE",
               ...
               "hssu6gcvno" {"enp2i0ivz6" "e;gqy:f*n|%AnR:\\jHZs",
                             "fx6vnv8e69" "p.Vb{zzr*55[<*M>hUgf",
                             "h92ffi29o3" "rZ>z]4/`<gPSK)WWhAET",
                             "luk7ad98pq" "c&Tp),.Hq\",zsd5G2r+d",
                             "sv0s8q62p0" "w)h*%gE`kc5;}VKO@!7&"},
               "qqq3rgklmt" [94142.51329181346 94128 false 58362 "eu[#3>NB^otu+<hnWS;y"],
               "rr0bmrmde6" 79506},
 "zo5retezoq" {"bls9cz2a1l" "j=mpY?_'zdJLY(C.(;!>",
               "gpimhgkpdn" "s}G[+rMB%fli\\C4<^IV!",
               "i0b8efcuwr" "g[/g-|SWDsa-\".j[IBkT",
               "l7m25li6u6" [79198 97596.7324385066 34258 true "pdP&6qvHR,TUxwQ.m^lm"],
               "zohi7usyc8" ["h.e5WCbHE>a#_)QjJTQ'" false 68057 47259 "ae?\"KM/i0@>s}6F.1.m0"]}}
